...
const GeneratePostDetailsOutputSchema = z.object({
  engagingCaption: z.string().describe('An engaging and relevant caption for the image, suitable for a general audience. It should start with a strong hook, potentially use a mini-thread structure if applicable, and end with a compelling call to action or finisher.'),
  professionalCaption: z.string().describe('A more formal or professional version of the caption. It should also start with a strong hook, maintain a clear structure, and end with a professional call to action or concluding thought.'),
  ...
  headlineText: z.string().describe('A short, bold, and engaging headline (3-7 words) for the image. This should be a powerful hook or concise benefit, highly relevant to the niche, category, and designed for maximum engagement.'),
...
1.  **Engaging Caption**: 
    ...
    *   **Finisher/CTA:** Conclude with a compelling call to action (e.g., "Comment below!", "Tap the link in bio!"), a thought-provoking question, or a strong finishing statement to encourage interaction.
...
2.  **Professional Caption**:
    ...
    *   **Finisher/CTA:** End with a professional call to action, an invitation for discussion, or a concise concluding thought.
    *   Maintain relevance to the niche and category.

3.  **Hashtags**: A comma-separated string of 3-5 highly relevant and effective hashtags for the niche and category. Focus on a mix of broad and specific terms.
